...
* **`unphased_predict.pass.vcf`** — Filtered SNP calls in VCF format generated by the `unphased_call` step.
* **`phased_predict.pass.vcf`** — Filtered SNP calls in VCF format generated by the `phased_call` step after haplotype phasing.

### **Supporting output files**

* **`unphased_predict.vcf`** — Unfiltered SNP calls in VCF format generated by the `unphased_call` step, including homozygous reference sites.
* **`phased_predict.vcf`** — Unfiltered SNP calls in VCF format generated by the `phased_call` step, including homozygous reference sites.
* **`unphased_predict.txt`** — Plain-text version of unfiltered SNP calls from the `unphased_call` step, including homozygous reference sites.
* **`phased_predict.txt`** — Plain-text version of unfiltered SNP calls from the `phased_call` step, including homozygous reference sites.
* **`unphased_predict.pass.txt`** — Plain-text version of filtered SNP calls generated by the `unphased_call` step.
* **`phased_predict.pass.txt`** — Plain-text version of filtered SNP calls generated by the `phased_call` step.
